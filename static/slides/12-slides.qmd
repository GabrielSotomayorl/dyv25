...
Calculamos la correlación entre `edad` y `trabajo no remunerado total` para cuantificar la relación lineal. En una correlación 1 nos indíca asociación lineal perfecta y 0 auscencia de asociación lineal. 
