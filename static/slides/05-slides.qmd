...
-   **Reconocer** los tipos de datos atómicos en R (`character`, `numeric`, `logical`) y el concepto de coerción.
-   **Aprender** un flujo de trabajo básico y reproducible para la exploración inicial de una base de datos.
-   **Aplicar** funciones básicas de R para realizar una "radiografía" inicial a un conjunto de datos real.
...
# 2. Los "Átomos" de los Datos en R
...
1.  **Vector** (La base de todo)
2.  **Lista** (El contenedor flexible)
3.  **Matriz** (La tabla numérica)
...
Una **lista** es como un "súper vector". Es un contenedor que puede guardar cualquier tipo de objeto, incluso de diferentes tipos y tamaños.
...
Afortunadamente, la mayoría de las encuestas sociológicas (como CASEN o EBS) ya vienen en este formato. Nuestro trabajo es mantener este orden.
...
-   **Nunca hacer trabajo manual:**
    -   El script debe ser autocontenido. Desde cargar los paquetes y los datos hasta el resultado final, todo debe ser ejecutable sin que tengas que "arreglar algo a mano en Excel".
...
## La "Radiografía" Inicial de los Datos {.smaller background-color="white"}
...
Un sociólogo recibe una base de datos sobre trabajadores y ejecuta `summary(datos)`. Parte del resultado es el siguiente:

```
##       edad          ingreso_mensual       contrato  
##  Min.   : 18.00   Min.   : -99000     Temporal: 250  
##  1st Qu.: 29.00   1st Qu.: 450000     Indefinido:600  
##  Median : 38.00   Median : 680000     Honorarios:150  
##  Mean   : 40.23   Mean   : 715000                     
##  3rd Qu.: 51.00   3rd Qu.: 950000                     
##  Max.   : 99.00   Max.   :25000000                     
##                   NA's   : 150
```

**En grupos, identifiquen al menos dos "banderas rojas" o problemas potenciales en estos datos que requerirían una investigación más a fondo antes de comenzar a analizar.**
