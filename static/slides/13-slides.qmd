...
-   **Introducir** el concepto sociológico clásico del **"modelo de elaboración"**: analizar la relación bivariada bajo el control de una tercera variable (Z).
...
**Problema:** Hay más mujeres que hombres en la muestra que contestó el diario. Comparar los conteos directos (9,742 vs. 17,646) puede ser engañoso. **Necesitamos porcentajes.**
...
3.  **Conclusión:** Un **98.2%** de las mujeres participa en trabajo doméstico, en comparación con un **94.1%** de los hombres. Como estos porcentajes son diferentes, concluimos que **existe una asociación** entre el sexo y la participación en trabajo doméstico en la muestra.
